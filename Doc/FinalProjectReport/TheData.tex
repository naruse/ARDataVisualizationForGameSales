...
%% Finally at the end of every chapter describing each major console and their
%% respective platforms, there is going to be an image that can be augmented with
%% \textit{ARMeet} to visualize the games sales each platform performed.
